...
<model-viewer id="reveal" loading="eager" id="paused-change-demo" camera-controls interaction-prompt="none" camera-orbit="90deg 90deg 40%" autoplay animation-name="TheLife" ar shadow-intensity="1" src="ModelsEarthSun/scene.gltf" ar="" ar-modes="scene-viewer webxr quick-look" ios-src="Earth-Moon-Sun.usdz" alt="APD-Earth-Sun" ar-scale="auto" camera-controls="" style="width: 100%; height: 500px" exposure="0.5"> <button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; ">
      👋 AR Click Here
  </button>
</model-viewer>
